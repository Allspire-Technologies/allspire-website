...
const DataProcessingAgreement = () => (
  <LegalPage slug="dpa" title="Data Processing Agreement" seoTitle="Data processing agreement" seoDescription="How Allspire processes personal data on behalf of its customers." snapshotEffective="2026-06-06">
