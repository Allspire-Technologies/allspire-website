...
const PrivacyPolicy = () => (
  <LegalPage slug="privacy" title="Privacy Policy" seoTitle="Privacy policy" seoDescription="How Allspire Technologies collects, uses and protects personal data." snapshotEffective="2026-06-06">
